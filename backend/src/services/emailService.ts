        ...
        await transporter.sendMail({
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 8px;">
                    ...
                    <p>Please log in to the <a href="http://localhost:4001/admin" style="color: #0066FF; text-decoration: none; font-weight: bold;">Admin Control Panel</a> to assign them to a workspace and approve their request.</p>
